function output = TCIMF_LCMV_noRm(HIM,indexes,options,gt,nys_flag,sr,ordered_class,k_th,group_k1)
...
%     [K_hat,E_hat] = KM_sub_HOCDver(HIM, options,sr,gt,currentclass_indexes,preclsr_indexes);%Rm
    [K_hat,E_hat] = KM_nys(HIM, options,sr,gt);
end
